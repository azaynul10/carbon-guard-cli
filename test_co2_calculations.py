...
class TestAWSAuditorCO2Calculations:
    ...
    def test_ec2_co2_calculation(self, aws_auditor):
        ...
        ec2.run_instances(
            ImageId="ami-fake", InstanceType="m5.large", MinCount=1, MaxCount=1
        )
    ...
    def test_multiple_instances_co2_aggregation(self, aws_auditor):
        ...
        expected_co2 = (
            (0.01 * 0.000415 * 2) + (0.08 * 0.000415 * 1) + (0.14 * 0.000415 * 1)
        )
...
class TestLocalAuditorCO2Calculations:
    ...
    def test_co2_calculation_from_metrics(self, local_auditor):
        ...
        expected_total_power = (
            expected_cpu_power + expected_memory_power + 0
        )  # No disk/network in this test
    ...
    def test_power_breakdown_calculation(self, local_auditor):
        ...
        expected_total_power = (
            expected_cpu_power
            + expected_memory_power
            + expected_disk_power
            + expected_network_power
        )
...
class TestUtilsCO2Calculations:
    ...
    def test_calculate_carbon_intensity(self):
        ...
        config = {
            ...
            "aws": {
                "carbon_intensity_by_region": {"us-east-1": 0.415, "eu-west-1": 0.316}
            },
        }
...
def temp_config_file():
    ...
    config_data = {
        ...
        "aws": {
            ...
            "carbon_intensity_by_region": {"us-east-1": 0.415, "us-west-2": 0.351},
        },
    }
